...
class SellerItemDetailScreen extends StatefulWidget {
  final User user, seller;
  final Item item;
  const SellerItemDetailScreen(
      {super.key,
      required this.user,
      required this.item,
  ...
  @override
  State<SellerItemDetailScreen> createState() => _sellerItemDetailsScreen();
}

class _sellerItemDetailsScreen extends State<SellerItemDetailScreen> {
